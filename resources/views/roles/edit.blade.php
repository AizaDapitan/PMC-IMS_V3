        ...
        <div class="col-md-12">
            ...
            <form class="col-md-4 col-md-offset-4" style="margin-top: 20px;" method="POST" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ $role->name }}" required maxlength="30">
                </div>

                <div class="form-group">
                    <label>Description <span class="required" aria-required="true"> * </span></label>
                    <input type="description" name="description" class="form-control" value="{{ $role->description }}" required maxlength="50">
                </div>                

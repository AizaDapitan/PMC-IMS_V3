            ...
            <div class="modal-body">
                <form autocomplete="off" method="post" action="{{ route('create.waybill') }}" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input required style="width: 100%;" name="manufacture_dt" class="form-control form-control-inline date-picker" type="text" data-date-format="yyyy-mm-dd" data-date-end-date="+0d"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input required style="width: 100%;" name="departure_dt" class="form-control form-control-inline date-picker" type="text" data-date-format="yyyy-mm-dd" data-date-end-date="+0d"/>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form autocomplete="off" method="post" action="/inTransit" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input required style="width: 100%;" name="arrival_dt" class="form-control form-control-inline date-picker" type="text" data-date-format="yyyy-mm-dd" data-date-end-date="+0d"/>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="col-sm-9">
                                <input required style="width: 100%;" name="start" id="start_dt" class="form-control form-control-inline date-picker" type="text" data-date-format="yyyy-mm-dd" data-date-end-date="+0d"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="col-sm-9">
                                <input style="width: 100%;" name="cleared" class="form-control form-control-inline date-picker" type="text" data-date-format="yyyy-mm-dd" data-date-end-date="+0d"/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form autocomplete="off" method="post" action="/delivered" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="col-sm-9">
                                <input required style="width: 100%;" name="delivered_dt" class="form-control form-control-inline date-picker" type="text" data-date-format="yyyy-mm-dd" data-date-end-date="+0d"/>
                            </div>
                        </div>
                    </div>
